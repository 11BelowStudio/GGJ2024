...
namespace Scripts.Utils.Types
{
    ...
    public class Singleton<T> : MonoBehaviour where T : Singleton<T>
    {
        ...
        /// </summary>
        /// <returns>true if this is the instance</returns>
        ...
        /// <summary>
        /// Attempts to obtain the instance of the singleton
        /// </summary>
        /// <param name="theInstance">Will hold the instance of the singleton if it exists.</param>
        /// <returns>
        ...
        /// <summary>
        /// If this is the instance, set the instance to null
        /// </summary>
